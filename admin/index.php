...
<html lang="en">
	<head>
		...
		<!-- MetisMenu CSS -->
		<link href="<?=$resources->getStaticResource("admin/css/metisMenu.min.css");?>" rel="stylesheet">

		<!-- Timeline CSS -->
		<link href="<?=$resources->getStaticResource("admin/css/timeline.css");?>" rel="stylesheet">

		<!-- Custom CSS -->
		<link href="<?=$resources->getStaticResource("admin/css/sb-admin-2.css");?>" rel="stylesheet">

		<!-- Morris Charts CSS -->
		<link href="<?=$resources->getStaticResource("admin/css/morris.css");?>" rel="stylesheet">

		<!-- Custom Fonts -->
		<link href="<?=$resources->getStaticResource("admin/css/font-awesome.min.css");?>" rel="stylesheet" type="text/css">
